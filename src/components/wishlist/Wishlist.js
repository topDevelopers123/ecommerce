            ...
            <div className='container'>
                ...
                <div className='wish-list p-0 w-100 '>
                    ...
                    <div className='wish-text wish-text-1 text-center  col-lg-10 d-flex justify-content-between'>
                        <h6 className='col-lg-3  col-12'>NAME</h6>
                        <h6 className='col-lg-3  col-12'>TOTAL</h6>
                        <h6 className='col-lg-3  col-12'>ADD TO CART</h6>
                        <h6 className='col-lg-3  col-12'><i class="bi bi-trash3"></i></h6>
                ...
                <div className='wish-items text-center w-100 '>
                    ...
                    <div className='wish-text wish-text-2   col-lg-10 col-md-7 col-sm-7 col-7 d-flex justify-content-between '>
                        <Link className='col-lg-3 col-md-12 col-sm-12 '>EYEBOGLER Polo T-shirt For Men</Link>
                        <h6 className='col-lg-3 col-md-12 col-sm-12 '>$ 199.00</h6>
                        <div className='col-lg-3 col-md-12 col-sm-12 '>
                            <button >ADD TO CART</button></div>
                        <h6 className='col-lg-3 col-md-12 col-sm-12 '><i class="bi bi-trash3"></i></h6>
                    </div>
                </div>
