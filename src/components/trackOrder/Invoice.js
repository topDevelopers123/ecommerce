                    ...
                    <table className="w-full border-collapse ">
                        <thead className="">
                            <tr className='border-y-2 ' >
                                <th className="pt-1 pb-4 px-2">Item</th>
                                <th className="pt-1 pb-4 px-2">Quantity</th>
                              
                                <th className="pt-1 pb-4 px-2">SGST</th>
                                <th className="pt-1 pb-4 px-2">CGST</th>
                                <th className="pt-1 pb-4 px-2">IGST</th>
